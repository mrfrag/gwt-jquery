...
public class JQueryElement<T> extends Node {
     ...
     *
     * @param selectorOrHtml A string representing a selector expression to find additional elements to add to the set of
     *                       matched elements.
     ...
     * Create a new jQuery object with elements added to the set of matched elements.
     *
     * @param selector A string representing a selector expression to find additional elements to add to the set of matched
     *                 elements.
     * @param context  The point in the document at which the selector should begin matching; similar to the context argument
     *                 of the $(selector, context) method.
     * @return self {@link JQueryElement}
     */
     ...
     * Adds the specified class(es) to each element in the set of matched elements.
     *
     * @param function A function returning one or more space-separated class names to be added to the existing class
     ...
     * Insert content, specified by the parameter, after each element in the set of matched elements.
     *
     * @param function A function that returns an HTML string, DOM element(s), or jQuery object to insert after each element
     *                 in the set of matched elements. Receives the index position of the element in the set as an argument.
     ...
     *
     * @param function A function that returns an HTML string, DOM element(s), or jQuery object to insert after each element
     *                 in the set of matched elements. Receives the index position of the element in the set and the old HTML
     *                 value of the element as arguments. Within the function, this refers to the current element in the
     *                 set.
     * @return self {@link JQueryElement}
     */
    ...
    /**
     * Add the previous set of elements on the stack to the current set. Note: This function has been deprecated and is now
     * an alias for .addBack(), which should be used with jQuery 1.8 and later.
     *
     ...
     *
     * @param htmlString HTML string the matched set of elements will be inserted at the end of the element(s) specified by
     *                   this parameter.
     * @return self {@link JQueryElement}
     */
     ...
     * Insert every element in the set of matched elements to the end of the target.
     *
     * @param element jQuery objects the matched set of elements will be inserted at the end of the element(s) specified by
     *                this parameter.
     * @return self {@link JQueryElement}
     */
     ...
     * Insert every element in the set of matched elements to the end of the target.
     *
     * @param element DOM elements the matched set of elements will be inserted at the end of the element(s) specified by
     *                this parameter.
     * @return self {@link JQueryElement}
     */
     ...
     *
     * @param attr     The name of the attribute to set.
     * @param function A function returning the value to set. this is the current element. Receives the index position of the
     *                 element in the set and the old attribute value as arguments.
     * @return self {@link JQueryElement}
     */
     ...
     * Attach a handler to an event for the elements.
     *
     * @param eventType     A string containing one or more DOM event types, such as "click" or "submit," or custom event
     *                      names.
     * @param eventData     An object containing data that will be passed to the event handler.
     ...
     * Create a deep copy of the set of matched elements.
     *
     * @param withDataAndEvents A Boolean indicating whether event handlers should be copied along with the elements. As of
     ...
     * Create a deep copy of the set of matched elements.
     *
     * @param withDataAndEvents     A Boolean indicating whether event handlers should be copied along with the elements. As
     *                              of jQuery 1.4, element data will be copied as well.
     * @param deepWithDataAndEvents A Boolean indicating whether event handlers and data for all children of the cloned
     *                              element should be copied. By default its value matches the first argument's value (which
     *                              defaults to false).
     * @return self {@link JQueryElement}
     */
     ...
     *
     * @param selector A string containing a selector expression to match elements against.
     * @param context  A DOM element within which a matching element may be found. If no context is passed in then the
     *                 context of the jQuery set will be used instead.
     * @return self {@link JQueryElement}
     */
     ...
     *
     * @param propertyName A CSS property.
     * @param function     A function returning the value to set. this is the current element. Receives the index position of
    ...
    /**
     * Return the value at the named data store for the first element in the jQuery collection, as set by data(name, value)
     * or by an HTML5 data-* attribute.
     *
    ...
    /**
     * Attach a handler to one or more events for all elements that match the selector, now or in the future, based on a
     * specific set of root elements.
     *
     * @param selector  A selector to filter the elements that trigger the event.
     * @param eventType A string containing one or more space-separated JavaScript event types, such as "click" or "keydown,"
    ...
    /**
     * End the most recent filtering operation in the current chain and return the set of matched elements to its previous
     * state.
     *
     * @return self {@link JQueryElement}
     */
     ...
     *
     * @param index An integer indicating the 0-based position of the element. or, An integer indicating the position of the
    ...
    /**
     * Get the descendants of each element in the current set of matched elements, filtered by a selector, jQuery object, or
     * element.
     *
     * @param selector A string containing a selector expression to match elements against.
     * @return self {@link JQueryElement}
    ...
    /**
     * Stop the currently-running animation, remove all queued animations, and complete all animations for the matched
     * elements.
     *
     * @return self {@link JQueryElement}
     */
     ...
     *
     * @return All of the matched DOM nodes are returned by this call, contained in a standard array:
     */
     ...
     * Set the CSS height of every matched element.
     *
     * @param function A function returning the height to set. Receives the index position of the element in the set and the
     *                 old height as arguments. Within the function, this refers to the current element in the set. You can
     ...
     * Set the HTML contents of each element in the set of matched elements.
     *
     * @param function A function returning the HTML content to set. Receives the index position of the element in the set
    ...
    /**
     * Get the current computed height for the first element in the set of matched elements, including padding but not
     * border.
     */
     ...
     * Set the CSS inner height of each element in the set of matched elements.
     *
     * @param function A function returning the inner height (including padding but not border) to set. Receives the index
     *                 position of the element in the set and the old inner height as arguments. Within the function, this
     *                 refers to the current element in the set. Return String or Number.
     * @return self {@link JQueryElement}
     */
     ...
     *
     * @param selector A selector or HTML string; matched set of elements will be inserted after the element(s) specified by
     *                 this parameter.
     * @return self {@link JQueryElement}
     */
     ...
     * Insert every element in the set of matched elements after the target.
     *
     * @param element An element; matched set of elements will be inserted after the element(s) specified by this parameter.
     * @return self {@link JQueryElement}
     */
     ...
     * Insert every element in the set of matched elements after the target.
     *
     * @param element jQuery object; matched set of elements will be inserted after the element(s) specified by this
     *                parameter.
     * @return self {@link JQueryElement}
     */
    ...
    /**
     * Check the current matched set of elements against a selector, element, or jQuery object and return true if at least
     ...
     * one of these elements matches the given arguments.
     *
     * @param function A function used as a test for every element in the set. It accepts two arguments, index, which is the
     *                 element's index in the jQuery collection, and element, which is the DOM element. Within the function,
     *                 this refers to the current DOM element. Return a Boolean value.
     * @return return true if at least one of these elements matches the given arguments
     */
    ...
    /**
     * Pass each element in the current matched set through a function, producing a new jQuery object containing the return
     * values.
     *
    ...
    /**
     * Get all following siblings of each element up to but not including the element matched by the selector, DOM node, or
     * jQuery object passed.
     *
     * @param selector A string containing a selector expression to indicate where to stop matching following sibling
     *                 elements.
     ...
     *
     * @param selector A string containing a selector expression, a DOM element, or an array of elements to match against the
     *                 set.
     * @return self {@link JQueryElement}
     */
     ...
     * Remove elements from the set of matched elements.
     *
     * @param function A function used as a test for each element in the set. It accepts two arguments, index, which is the
     *                 element's index in the jQuery collection, and element, which is the DOM element. Within the function,
     ...
     * Remove an event handler.
     *
     * @param events One or more space-separated event types and optional namespaces, or just namespaces, such as "click",
     *               "keydown.myPlugin", or ".myPlugin".
     * @return self {@link JQueryElement}
     */
     ...
     * @param events   One or more space-separated event types and optional namespaces, or just namespaces, such as "click",
     *                 "keydown.myPlugin", or ".myPlugin".
     * @param selector A selector which should match the one originally passed to .off() when attaching event handlers.
     * @param handler  A handler function previously attached for the event(s), or the special value false.
     * @return self {@link JQueryElement}
     */
     ...
     * Set the current coordinates of every element in the set of matched elements, relative to the document.
     *
     * @param function A function to return the coordinates to set. Receives the index of the element in the collection as
    ...
    /**
     * Get the current computed height for the first element in the set of matched elements, including padding, border, and
     * optionally margin. Returns a number (without "px") representation of the value or null if called on an empty set of
     * elements.
     ...
     * Set the CSS outer Height of each element in the set of matched elements.
     *
     * @param function A function returning the outer height to set. Receives the index position of the element in the set
     *                 and the old outer height as arguments. Within the function, this refers to the current element in the
     *                 set.
     * @return self {@link JQueryElement}
     */
    ...
    /**
     * Get the current computed width for the first element in the set of matched elements, including padding, border, and
     * optionally margin. Returns a number (without "px") representation of the value or null if called on an empty set of
     * elements.
     * <pre><img src="https://api.jquery.com/resources/0042_04_03.png"/></pre>
     */
    ...
    /**
     * Get the ancestors of each element in the current set of matched elements, up to but not including the element matched
    ...
    /**
     * Get all preceding siblings of each element up to but not including the element matched by the selector, DOM node, or
     * jQuery object.
     *
     * @return self {@link JQueryElement}
     */
    ...
    /**
     * GGet all preceding siblings of each element up to but not including the element matched by the selector, DOM node, or
     * jQuery object.
     *
     * @param selector A string containing a selector expression to indicate where to stop matching ancestor elements.
     * @return self {@link JQueryElement}
    ...
    /**
     * Return a Promise object to observe when all actions of a certain type bound to the collection, queued or not, have
     * finished.
     *
     * @return returns a dynamically generated Promise that is resolved once all actions of a certain type bound to the
     * collection, queued or not, have ended.
     */
     ...
     *
     * @param propertyName The name of the property to set.
     * @param function     A function returning the value to set. Receives the index position of the element in the set and
     *                     the old property value as arguments. Within the function, the keyword this refers to the current
     *                     element.
     * @return self {@link JQueryElement}
     */
     ...
     * Remove a single class, multiple classes, or all classes from each element in the set of matched elements.
     *
     * @param function A function returning one or more space-separated class names to be removed. Receives the index
     *                 position of the element in the set and the old class value as arguments. Must return a String.
     * @return self {@link JQueryElement}
     */
    ...
    /**
     * Replace each element in the set of matched elements with the provided new content and return the set of elements that
     * was removed.
     *
     ...
     *
     * @return The horizontal scroll position is the same as the number of pixels that are hidden from view to the left of
     * the scrollable area. If the scroll bar is at the very left, or if the element is not scrollable, this number will be
     * 0.
     */
    ...
    /**
     * Get the current vertical position of the scroll bar for the first element in the set of matched elements or set the
     * vertical position of the scroll bar for every matched element.
     *
     * @return The vertical scroll position is the same as the number of pixels that are hidden from view above the
     * scrollable area. If the scroll bar is at the very top, or if the element is not scrollable, this number will be 0.
     */
     ...
     *
     * @return he .serialize() method creates a text string in standard URL-encoded notation. It can act on a jQuery object
     * that has selected individual form controls.
     */
     ...
     *
     * @return creates a JavaScript array of objects, ready to be encoded as a JSON string. It operates on a jQuery
     ...
     *
     * @param start An integer indicating the 0-based position at which the elements begin to be selected. If negative, it
     ...
     * @param start An integer indicating the 0-based position at which the elements begin to be selected. If negative, it
     *              indicates an offset from the end of the set.
     * @param end   An integer indicating the 0-based position at which the elements stop being selected. If negative, it
     ...
     * Set the content of each element in the set of matched elements to the specified text.
     *
     * @param function A function returning the text content to set. Receives the index position of the element in the set
     *                 and the old text value as arguments. Must return a String value.
     * @return self {@link JQueryElement}
     */
     ...
     * presence or the value of the state argument.
     *
     * @param function A function that returns class names to be toggled in the class attribute of each element in the
     *                 matched set. Receives the index position of the element in the set, the old class value, and the state
     *                 as arguments.
     * @return self {@link JQueryElement}
     */
     ...
     *
     * @param eventType A string containing a JavaScript event type, such as click or submit.
     * @param falsed    Unbinds the corresponding 'return false' function that was bound using .bind( eventType, false ).
     * @return self {@link JQueryElement}
     */
     ...
     *
     * @param wrappingElement A selector or HTML string specifying the structure to wrap around the matched elements. A
     ...
     * Wrap an HTML structure around each element in the set of matched elements.
     *
     * @param wrappingElement A jQuery object specifying the structure to wrap around the matched elements. When you pass a
     *                        jQuery collection containing more than one element, or a selector matching more than one
     *                        element, the first element will be used.
     * @return self {@link JQueryElement}
     */
     ...
     * Wrap an HTML structure around each element in the set of matched elements.
     *
     * @param function A callback function returning the HTML content or jQuery object to wrap around the matched elements.
     *                 Receives the index position of the element in the set as an argument. Within the function, this refers
     *                 to the current element in the set. Must return a String or jQuery element.
     * @return self {@link JQueryElement}
     */
     ...
     * Set the value of each element in the set of matched elements.
     *
     * @param value a number corresponding to the value of each matched element to set as selected/checked.
     * @return self {@link JQueryElement}
     */
     ...
     * Set the CSS width of each element in the set of matched elements.
     *
     * @param function A function returning the width to set. Receives the index position of the element in the set and the
     *                 old width as arguments. Within the function, this refers to the current element in the set. Must
